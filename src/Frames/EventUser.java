...
import Classes.User;
import static Frames.FrameFiltersDate.combo;
...
import Methods.MethodsFriendListUser;
...
public class EventUser extends javax.swing.JFrame {
    public static ArrayList<String>comboList = new ArrayList<String>();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Mis Eventos");

        jLabel9.setText("Lista de Amigos ");
        ...
        jButton8.setText("Administrar Eventos");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(jButton5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        EventsUser filters= new  EventsUser();
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ModifyEvent modify= new ModifyEvent();
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().isEmpty()|| jTextField2.getText().isEmpty()||jTextField3.getText().isEmpty()){//||jTextField4.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"Verifique que no existan campos vacíos");
        }else {
            ...
            event.insertarInicioCircular(nombre,descripcion, ciudad,fechaDate);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
       EventsInvite even= new EventsInvite();
       this.dispose();
     ...
     public void list(){
         ...
         if(nuevo.nextEvent.getIDEvent()==Main.event.inicioEvento.getIDEvent()){
             if(nuevo.getSend()==userLogin){
                 events.add(nuevo.getIDEvent()+"-"+nuevo.getNameEvent());
             }
         }else{
             do{
                if(nuevo.getSend()==userLogin){
         ...
         for (int i = 0; i < events.size(); i++) {             
             jComboBox1.addItem(events.get(i));
         }
    ...
    public static MethodsFriendList getInstance(){
     ...
     public boolean listFriensds(){
        ...
        if(auxList!=null){
            ...
            if (auxList.nextUser!=null){
                if (auxList.nextUser.identification==Main.user.identification){ //si es el creador de la lista
                    ...
                    comboList.add(auxList.getNameList());
                }
                    }
        ...
        for (int i = 0; i < comboList.size(); i++) {
             jComboBox2.addItem(comboList.get(i));
         }
        }
     ...
     public void eventSend(){
        MethodsFriendList metFriendList = MethodsFriendList.getInstance();
        MethodsUserEvent metUserEvent = MethodsUserEvent.getInstance();
        UserMethods metUser = UserMethods.getInstance();
        char myEvents=jComboBox1.getSelectedItem().toString().charAt(0);
        String list=(String)jComboBox2.getSelectedItem();
        
        FriendList listFriends= metFriendList.searchFriendList(list);
        Event event= Main.event.buscarEvento(Character.getNumericValue(myEvents));     
        FriendListUser auxUserList = listFriends.nextFriendListUser;      
        
        while(auxUserList != null){
            System.out.println(auxUserList.nextUser.userName);
            
            
            metUserEvent.insertSubUser(Character.getNumericValue(myEvents), auxUserList.nextUser.identification);
            auxUserList = auxUserList.next;
        }
