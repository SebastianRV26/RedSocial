 ...
 * @author yosin
 */
public class FiltersEventsUser extends javax.swing.JFrame {
    DefaultListModel<String> list= new DefaultListModel<>();
    /**
     * Creates new form FiltersEvents
     */
    public FiltersEventsUser() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FiltersEventsUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FiltersEventsUser().setVisible(true);
            }
        });
    }
